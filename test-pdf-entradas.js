// Teste otimizado apenas para o arquivo entrada.pdf
  ...
  try {
    ...
    const response = await client.chat.complete({
      ...
      messages: [
        ...
        {
          role: "user",
          content: `Extraia os dados das reservas encontradas neste relatório de CHECK-INS:\n\n${text.substring(0, 1500)}`
        }
      ],
      tools: [
        {
...
async function main() {
  console.log('🔄 Iniciando teste de processamento do arquivo entrada.pdf...');
