...
// import { enforceCleanMode } from "./enforce-clean-mode"; // Desativado para permitir chamadas API normais
...
function App() {
  ...
  useEffect(() => {
    ...
    // enforceCleanMode(); // Desativado para permitir chamadas API normais
