...
export class GeminiService {
  ...
  private initialize(apiKey: string): void {
    try {
      ...
      // Inicializar SDK oficial do Google
      this.genAI = new GoogleGenerativeAI(apiKey);

      console.log("✅ Google Generative AI SDK inicializado");
      console.log("🚀 Usando @google/genai v1.x com Gemini 2.0 Flash");

      // Inicializar todos os modelos Gemini 2.0 Flash
      ...
      // Gemini 2.0 Flash é multimodal nativo (texto + imagem + áudio + vídeo)
      this.visionModel = this.defaultModel;
      this.audioModel = this.defaultModel;

      // Validar API key de forma assíncrona
      this.validateApiKey(apiKey)
        .then(isValid => {
          ...
          if (isValid) {
            ...
            console.log("💰 Economia de ~20% vs Gemini 1.5 Pro");
          } else {
